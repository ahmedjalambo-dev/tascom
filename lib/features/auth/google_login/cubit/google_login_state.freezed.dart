...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoogleLoginState);
}
...
/// @nodoc
class $GoogleLoginStateCopyWith<$Res>  {
$GoogleLoginStateCopyWith(GoogleLoginState _, $Res Function(GoogleLoginState) __);
}
...
class _Initial implements GoogleLoginState {
  const _Initial();
...
class _Loading implements GoogleLoginState {
  const _Loading();
...
@override
String toString() {
  return 'GoogleLoginState.loading()';
}
...
class _Success implements GoogleLoginState {
...
@override
String toString() {
  return 'GoogleLoginState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $GoogleLoginStateCopyWith<$Res> {
...
class _Error implements GoogleLoginState {
...
@override
String toString() {
  return 'GoogleLoginState.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GoogleLoginStateCopyWith<$Res> {
