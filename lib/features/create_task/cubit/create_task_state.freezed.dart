...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateTaskState);
}
...
/// @nodoc
class $CreateTaskStateCopyWith<$Res>  {
$CreateTaskStateCopyWith(CreateTaskState _, $Res Function(CreateTaskState) __);
}
...
class _Initial implements CreateTaskState {
  const _Initial();
...
class _Loading implements CreateTaskState {
  const _Loading();
...
class _Success implements CreateTaskState {
  const _Success();
...
class _Error implements CreateTaskState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateTaskStateCopyWith<$Res> {
