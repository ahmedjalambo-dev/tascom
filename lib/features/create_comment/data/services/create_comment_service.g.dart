...
part of 'create_comment_service.dart';
...
class _CreateCommentService implements CreateCommentService {
  _CreateCommentService(this._dio, {this.baseUrl, this.errorLogger});
