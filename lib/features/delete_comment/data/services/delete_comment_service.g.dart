...
part of 'delete_comment_service.dart';
...
class _DeleteCommentService implements DeleteCommentService {
  _DeleteCommentService(this._dio, {this.baseUrl, this.errorLogger});
